...
screenWidth = 480 #112
screenHeight = 320 #116
 
grasstile = [
    pygame.image.load("assets/qq.png"), pygame.image.load("assets/ww.png"), pygame.image.load("assets/ee.png"), pygame.image.load("assets/rr.png"), pygame.image.load("assets/tt.png"),
    pygame.image.load("assets/yy.png"), pygame.image.load("assets/uu.png"), pygame.image.load("assets/ii.png"), pygame.image.load("assets/oo.png"), pygame.image.load("assets/pp.png"),
    pygame.image.load("assets/aa.png"), pygame.image.load("assets/ss.png"), pygame.image.load("assets/dd.png"), pygame.image.load("assets/grass TR4.png"), pygame.image.load("assets/grass TR5.png"),
    pygame.image.load("assets/grass BR1.png"), pygame.image.load("assets/grass BR2.png"), pygame.image.load("assets/grass BR3.png"), pygame.image.load("assets/grass BR4.png"), pygame.image.load("assets/grass BR5.png")
    ]
woodtile = [
    pygame.image.load("assets/wood TL1.png"), pygame.image.load("assets/wood TL2.png"), pygame.image.load("assets/wood TL3.png"), pygame.image.load("assets/wood TL4.png"), pygame.image.load("assets/wood TL5.png"),
    pygame.image.load("assets/wood BL1.png"), pygame.image.load("assets/wood BL2.png"), pygame.image.load("assets/wood BL3.png"), pygame.image.load("assets/wood BL4.png"), pygame.image.load("assets/wood BL5.png"),
    pygame.image.load("assets/wood TR1.png"), pygame.image.load("assets/wood TR2.png"), pygame.image.load("assets/wood TR3.png"), pygame.image.load("assets/wood TR4.png"), pygame.image.load("assets/wood TR5.png"),
    pygame.image.load("assets/wood BR1.png"), pygame.image.load("assets/wood BR2.png"), pygame.image.load("assets/wood BR3.png"), pygame.image.load("assets/wood BR4.png"), pygame.image.load("assets/wood BR5.png")
    ]
cloudtile = [
    pygame.image.load("assets/cloud TL1.png"), pygame.image.load("assets/cloud TL2.png"), pygame.image.load("assets/cloud TL3.png"), pygame.image.load("assets/cloud TL4.png"), pygame.image.load("assets/cloud TL5.png"),
    pygame.image.load("assets/cloud BL1.png"), pygame.image.load("assets/cloud BL2.png"), pygame.image.load("assets/cloud BL3.png"), pygame.image.load("assets/cloud BL4.png"), pygame.image.load("assets/cloud BL5.png"),
    pygame.image.load("assets/cloud TR1.png"), pygame.image.load("assets/cloud TR2.png"), pygame.image.load("assets/cloud TR3.png"), pygame.image.load("assets/cloud TR4.png"), pygame.image.load("assets/cloud TR5.png"),
    pygame.image.load("assets/cloud BR1.png"), pygame.image.load("assets/cloud BR2.png"), pygame.image.load("assets/cloud BR3.png"), pygame.image.load("assets/cloud BR4.png"), pygame.image.load("assets/cloud BR5.png")
    ]
castletile = [
    pygame.image.load("assets/castle TL1.png"), pygame.image.load("assets/castle TL2.png"), pygame.image.load("assets/castle TL3.png"), pygame.image.load("assets/castle TL4.png"), pygame.image.load("assets/castle TL5.png"),
    pygame.image.load("assets/castle BL1.png"), pygame.image.load("assets/castle BL2.png"), pygame.image.load("assets/castle BL3.png"), pygame.image.load("assets/castle BL4.png"), pygame.image.load("assets/castle BL5.png"),
    pygame.image.load("assets/castle TR1.png"), pygame.image.load("assets/castle TR2.png"), pygame.image.load("assets/castle TR3.png"), pygame.image.load("assets/castle TR4.png"), pygame.image.load("assets/castle TR5.png"),
    pygame.image.load("assets/castle BR1.png"), pygame.image.load("assets/castle BR2.png"), pygame.image.load("assets/castle BR3.png"), pygame.image.load("assets/castle BR4.png"), pygame.image.load("assets/castle BR5.png")
    ]
autumntile = [
    pygame.image.load("assets/autumn TL1.png"), pygame.image.load("assets/autumn TL2.png"), pygame.image.load("assets/autumn TL3.png"), pygame.image.load("assets/autumn TL4.png"), pygame.image.load("assets/autumn TL5.png"),
    pygame.image.load("assets/autumn BL1.png"), pygame.image.load("assets/autumn BL2.png"), pygame.image.load("assets/autumn BL3.png"), pygame.image.load("assets/autumn BL4.png"), pygame.image.load("assets/autumn BL5.png"),
    pygame.image.load("assets/autumn TR1.png"), pygame.image.load("assets/autumn TR2.png"), pygame.image.load("assets/autumn TR3.png"), pygame.image.load("assets/autumn TR4.png"), pygame.image.load("assets/autumn TR5.png"),
    pygame.image.load("assets/autumn BR1.png"), pygame.image.load("assets/autumn BR2.png"), pygame.image.load("assets/autumn BR3.png"), pygame.image.load("assets/autumn BR4.png"), pygame.image.load("assets/autumn BR5.png")
    ]
ruinstile = [
    pygame.image.load("assets/ruins TL1.png"), pygame.image.load("assets/ruins TL2.png"), pygame.image.load("assets/ruins TL3.png"), pygame.image.load("assets/ruins TL4.png"), pygame.image.load("assets/ruins TL5.png"),
    pygame.image.load("assets/ruins BL1.png"), pygame.image.load("assets/ruins BL2.png"), pygame.image.load("assets/ruins BL3.png"), pygame.image.load("assets/ruins BL4.png"), pygame.image.load("assets/ruins BL5.png"),
    pygame.image.load("assets/ruins TR1.png"), pygame.image.load("assets/ruins TR2.png"), pygame.image.load("assets/ruins TR3.png"), pygame.image.load("assets/ruins TR4.png"), pygame.image.load("assets/ruins TR5.png"),
    pygame.image.load("assets/ruins BR1.png"), pygame.image.load("assets/ruins BR2.png"), pygame.image.load("assets/ruins BR3.png"), pygame.image.load("assets/ruins BR4.png"), pygame.image.load("assets/ruins BR5.png")
    ]
beanstalktile = [
    pygame.image.load("assets/beanstalk TL1.png"), pygame.image.load("assets/beanstalk TL2.png"), pygame.image.load("assets/beanstalk TL3.png"), pygame.image.load("assets/beanstalk TL4.png"), pygame.image.load("assets/beanstalk TL5.png"),
    pygame.image.load("assets/beanstalk BL1.png"), pygame.image.load("assets/beanstalk BL2.png"), pygame.image.load("assets/beanstalk BL3.png"), pygame.image.load("assets/beanstalk BL4.png"), pygame.image.load("assets/beanstalk BL5.png"),
    pygame.image.load("assets/beanstalk TR1.png"), pygame.image.load("assets/beanstalk TR2.png"), pygame.image.load("assets/beanstalk TR3.png"), pygame.image.load("assets/beanstalk TR4.png"), pygame.image.load("assets/beanstalk TR5.png"),
    pygame.image.load("assets/beanstalk BR1.png"), pygame.image.load("assets/beanstalk BR2.png"), pygame.image.load("assets/beanstalk BR3.png"), pygame.image.load("assets/beanstalk BR4.png"), pygame.image.load("assets/beanstalk BR5.png")
    ]
skytile = [
    pygame.image.load("assets/sky TL1.png"), pygame.image.load("assets/sky TL2.png"), pygame.image.load("assets/sky TL3.png"), pygame.image.load("assets/sky TL4.png"), pygame.image.load("assets/sky TL5.png"),
    pygame.image.load("assets/sky BL1.png"), pygame.image.load("assets/sky BL2.png"), pygame.image.load("assets/sky BL3.png"), pygame.image.load("assets/sky BL4.png"), pygame.image.load("assets/sky BL5.png"),
    pygame.image.load("assets/sky TR1.png"), pygame.image.load("assets/sky TR2.png"), pygame.image.load("assets/sky TR3.png"), pygame.image.load("assets/sky TR4.png"), pygame.image.load("assets/sky TR5.png"),
    pygame.image.load("assets/sky BR1.png"), pygame.image.load("assets/sky BR2.png"), pygame.image.load("assets/sky BR3.png"), pygame.image.load("assets/sky BR4.png"), pygame.image.load("assets/sky BR5.png")
    ]
tiles = [grasstile, woodtile, cloudtile, castletile, autumntile, ruinstile, skytile]
tile2 = [pygame.image.load("assets/tile0.png"), pygame.image.load("assets/tile5.png"), pygame.image.load("assets/tile6.png"), pygame.image.load("assets/tile1.png"), pygame.image.load("assets/tile2.png"), pygame.image.load("assets/tile3.png"), pygame.image.load("assets/tile4.png")]
 
frogAnimation = [pygame.image.load("assets/froggy2.png"), pygame.image.load("assets/froggy1.png"), pygame.image.load("assets/froggy4.png"), pygame.image.load("assets/froggy3.png"), pygame.image.load("assets/froggy8.png"), pygame.image.load("assets/froggy7.png")]
legAnimation = [pygame.image.load("assets/Leg0.png"), pygame.image.load("assets/Leg1.png"), pygame.image.load("assets/Leg2.png"), pygame.image.load("assets/Leg3.png"),]
tongueTexture = pygame.image.load("assets/tongue.png")
flipBlockAnimation = [pygame.image.load("assets/flipblock0.png"), pygame.image.load("assets/flipblock1.png"), pygame.image.load("assets/flipblock2.png"), pygame.image.load("assets/flipblock3.png"), pygame.image.load("assets/flipblock4.png"), pygame.image.load("assets/flipblock5.png")]
coinAnimation = [pygame.image.load("assets/coin0.png"), pygame.image.load("assets/coin1.png"), pygame.image.load("assets/coin2.png"), pygame.image.load("assets/coin3.png"), pygame.image.load("assets/coin4.png"), pygame.image.load("assets/coin5.png")]
fruitAnimation = [pygame.image.load("assets/fruit0.png"), pygame.image.load("assets/fruit1.png"), pygame.image.load("assets/fruit0.png"), pygame.image.load("assets/fruit2.png")]
platformSprite = pygame.image.load("assets/platform.png")
greenBlockAnimation = [pygame.image.load("assets/greenblock.png"), pygame.image.load("assets/greenblock1.png")]
popAnimation = [pygame.image.load("assets/pop0.png"), pygame.image.load("assets/pop1.png"), pygame.image.load("assets/pop2.png"), pygame.image.load("assets/pop3.png")]
jimAnimation = [pygame.image.load("assets/jim0.png"), pygame.image.load("assets/jim1.png")]
spikeJimAnimation = [pygame.image.load("assets/spikejim0.png"), pygame.image.load("assets/spikejim1.png")]
goalSignAnimation = [pygame.image.load("assets/goalsign0.png"), pygame.image.load("assets/goalsign1.png"), pygame.image.load("assets/goalsign2.png"), pygame.image.load("assets/goalsign1.png")]
goalSignFlippingAnimation = [pygame.image.load("assets/goalsign0.png"), pygame.image.load("assets/goalsign3.png"), pygame.image.load("assets/goalsign4.png"), pygame.image.load("assets/goalsign5.png"), pygame.image.load("assets/goalsign6.png"), pygame.image.load("assets/goalsign7.png")]
spinJimAnimation = [pygame.image.load("assets/spinjim0.png"), pygame.image.load("assets/spinjim1.png"), pygame.image.load("assets/spinjim2.png"), pygame.image.load("assets/spinjim3.png")]
flowerAnimation = [pygame.image.load("assets/flower0.png"), pygame.image.load("assets/flower1.png"), pygame.image.load("assets/flower2.png"), pygame.image.load("assets/flower3.png")]
invisibleBlockAnimation = [pygame.image.load("assets/invisibleblock0.png"), pygame.image.load("assets/invisibleblock1.png"), pygame.image.load("assets/invisibleblock2.png")]
ironBlockAnimation = [pygame.image.load("assets/gearblock2.png"), pygame.image.load("assets/gearblock3.png")]
gearBlockAnimation = [pygame.image.load("assets/gearblock0.png"), pygame.image.load("assets/gearblock1.png")]
NumFont = [pygame.image.load("assets/Num 0.png"), pygame.image.load("assets/Num 1.png"), pygame.image.load("assets/Num 2.png"), pygame.image.load("assets/Num 3.png"), pygame.image.load("assets/Num 4.png"), pygame.image.load("assets/Num 5.png"), pygame.image.load("assets/Num 6.png"), pygame.image.load("assets/Num 7.png"), pygame.image.load("assets/Num 8.png"), pygame.image.load("assets/Num 9.png")]
leafAnimation = [pygame.image.load("assets/leaf0.png"), pygame.image.load("assets/leaf1.png"), pygame.image.load("assets/leaf2.png"), pygame.image.load("assets/beanstalkleaf0.png"), pygame.image.load("assets/beanstalkleaf1.png"), pygame.image.load("assets/beanstalkleaf2.png")]
jigsawAnimation = [pygame.image.load("assets/jigsaw0.png"), pygame.image.load("assets/jigsaw1.png"), pygame.image.load("assets/jigsaw2.png"), pygame.image.load("assets/jigsaw3.png")]
flowerAnimation2 = [pygame.image.load("assets/flower4.png"), pygame.image.load("assets/flower5.png")]
stoneBlockAnimation = [pygame.image.load("assets/stoneblock0.png"), pygame.image.load("assets/stoneblock1.png"), pygame.image.load("assets/stoneblock2.png"), pygame.image.load("assets/stoneblock3.png.png")]
jigsawAnimation = [pygame.image.load("assets/jigsaw0.png"), pygame.image.load("assets/jigsaw1.png"), pygame.image.load("assets/jigsaw2.png"), pygame.image.load("assets/jigsaw3.png"),]
yellowBlockAnimation = [pygame.image.load("assets/yellowblock0.png"), pygame.image.load("assets/yellowblock1.png"), pygame.image.load("assets/yellowblock2.png")]
beanStalkAnimation = [pygame.image.load("assets/beanstalk.png")]
fruitBlockAnimation = [pygame.image.load("assets/fruitblock.png")]
stageEaterAnimation = [pygame.image.load("assets/stageeater0.png"), pygame.image.load("assets/stageeater1.png")]
particalAnimation = [pygame.image.load("assets/particle0.png"), pygame.image.load("assets/particle1.png"), pygame.image.load("assets/particle2.png"), pygame.image.load("assets/particle3.png"), pygame.image.load("assets/beanstalk TL5.png")]
froggoDeathAnimation = pygame.image.load("assets/froggy hurt.png")
portalAnimation = [pygame.image.load("assets/portal0.png"), pygame.image.load("assets/portal1.png"), pygame.image.load("assets/portal2.png"), pygame.image.load("assets/portal3.png"), pygame.image.load("assets/portal4.png")]
 
cloudBG = pygame.image.load("assets/background1.png")
castleBG = pygame.image.load("assets/background2.png")
skyBG = pygame.image.load("assets/background3.png")
plainsBG = pygame.image.load("assets/background4.png")
forestBG = pygame.image.load("assets/background5.png")
tallForestBG = pygame.image.load("assets/background6.png")
autumnBG = pygame.image.load("assets/background8.png")
ruinsBG = pygame.image.load("assets/background7.png")
...
class magicalOrb():
    def __init__(self, x ,y):
        ...
        self.Yspeed = 0
    def update(self):
        window.blit(pygame.image.load("assets/magicalorb.png"), (self.fx, self.y))
        if Tongue in level:
            Tongue.tongueDetect(self)
        self.y += self.Yspeed
        ...
        if levelProgress == 0:
            ...
            if timer > 300 and jigsawCountSave == 6:
                ...
                if not frog in level:
                    window.blit(pygame.image.load("assets/The end.png"), (112, 32))
            elif timer > 300:
                window.blit(pygame.image.load("assets/The end.png"), (112, 32))
...
while run and not keys[pygame.K_SPACE] and not keys[pygame.K_x]:          #Title screen
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            run = False
 
    window.blit(skyBG, (0,0))
    window.blit(pygame.image.load("assets/Title.png"), (112, 116))
    keys = pygame.key.get_pressed()
    pygame.display.update()
    ...
    while run and alive:    # Main loop
        ...
        if frog in level:
            ...
            if keys[pygame.K_RIGHT] and frog.x < screenWidth - frog.width:
                ...
                if not frog.mouthOpen:
                    frog.faceRight = True
            if keys[pygame.K_UP] and frog.onGround:
                frog.Yspeed = -10
            if frog in level and (keys[pygame.K_SPACE] or keys[pygame.K_x]) and spaceKeyCoolDown == 0 and not frog.mouthOpen and Tongue not in level:
                spaceKeyCoolDown = 16
                if len(frog.mouth) == 0:
