...
gajurel.color('blue') #setting the color og the turtle to red
gajurel.shape('classic') #declaring the shape of the turtle to "turtle"
...
turtleVar.color('red') #setting the color of the turtle as "blue"
turtleVar.shape('arrow') #declaring the shape of the turtle
turtleVar.penup() #not ready to draw
turtleVar.goto(-200,60) #positioning
